        ...
        <div className="backdrop-blur-xl bg-black/30 border border-white/10 shadow-2xl rounded-3xl p-8 text-white">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/70 text-sm">
              Mulai perjalanan undangan digitalmu
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <Button variant="outline" className="w-full bg-white text-navy hover:bg-gray-100 border-none h-11 rounded-xl font-medium flex items-center gap-2">
